				...
				<div id="stat_tab_options" class="tab">
					...
					<form method="post">
						...
						<div style="display:$vis_some;">	
							...
							<p><label for="rscrub_prefix">Prefix Trigger </label> <input type="text" id="rscrub_prefix" name="rscrub_prefix" value="$rscrub_prefix" /> <small>Changing this value might break rscrub</small></p>
						</div>
						<hr>
						...
						<div style="display:$vis_p;">
							<p>Current total number of rscrub pass-through events: $rscrub_pass_count </p>
							<p>Set a custom prefix, defaults to '+'</p>
							<p><label for="rscrub_pass_prefix">Prefix Trigger </label> <input type="text" id="rscrub_pass_prefix" name="rscrub_pass_prefix" value="$rscrub_pass_prefix" /> <small>Changing this value might break rscrub</small></p>
						</div>
						<hr>
